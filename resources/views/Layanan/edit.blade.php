        ...
        <div class="card-body text-white">
            ...
            <form action="{{ route('layanan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control bg-white bg-opacity-75 text-dark border-0" id="deskripsi" name="deskripsi" rows="4">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="harga" class="form-label">Harga</label>
                    <input type="number" class="form-control bg-white bg-opacity-75 text-dark border-0" id="harga" name="harga"
                           value="{{ old('harga', $layanan->harga) }}" min="0" step="0.01" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-3">
                        @if ($layanan->gambar)
                            ...
                            <img src="{{ asset('storage/' . $layanan->gambar) }}" alt="Gambar Saat Ini" class="rounded border" style="width: 100px; height: 100px; object-fit: cover;">
                        @endif
